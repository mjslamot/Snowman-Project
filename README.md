...
The animated image in the first video was created using Java.           
I used random values to create the christmas tree, horizon, and snowfall.         
Unfortunately, the laptop on which the project was saved broke, so the source code is unavailable.      

The second images is a bonus assignment for CS which was created using Racket                           
